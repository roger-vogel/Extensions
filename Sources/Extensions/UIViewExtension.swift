...
extension UIView {
    ...
    var endx: CGFloat {
        ...
        set { frame.size.width = newValue - frame.origin.x }
    }
    ...
    func roundAllCorners(value: CGFloat) { self.layer.cornerRadius = value }
    
    func frameInCircle() { roundAllCorners(value: self.frame.height/2) }
